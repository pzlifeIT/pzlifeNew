...
//        'three'   => ['only' => 'hello,data'],//只有hello,data方法进行three前置操作
    ...
    public function modifyCouponHd() {
        ...
        $result = $this->app->coupons->modifyCouponHd($status, $title, $content, $id);
        $this->apiLog($apiName, [$cmsConId, $id, $status, $title, $content], $result['code'], $cmsConId);
        return $result;
    }
     ...
     * @apiSuccess (返回) {String} code 200:成功 / 3001:优惠券金额有误 / 3002:id参数有误 / 3003:level参数有误 / 3004:标题不能为空 / 3005:days参数有误 / 3008:添加失败
     * @apiSuccess (返回) {String} msg 返回消息
