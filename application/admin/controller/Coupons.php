...
class Coupons extends AdminController {
    ...
    public function addHdGoods() {
        ...
        $result = $this->app->coupons->addHdGoods($hd_id, $image, $kind, $relevance, $debris, $title, $probability, $stock);
    ...
    public function saveHdGoods() {
        ...
        $result = $this->app->coupons->saveHdGoods($id, $image, $kind, $relevance, $debris, $title, $probability, $stock);
