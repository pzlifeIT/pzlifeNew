...
class Order extends MyController {
     ...
     * @apiParam (入参) {Number} [num] 购买数量
     * @apiParam (入参) {Ind} [user_coupon_id] 用户优惠券id
     * @apiSuccess (返回) {String} code 200:成功 / 3000:未获取到数据 / 3001.skuid错误 / 3002.con_id错误 /3003:地址id错误 / 3004:商品售罄 / 3006:商品不支持配送 / 3007:商品库存不够 / 3008:支付方式错误 / 3009:创建失败 / 3013:用户优惠券不可使用
